...
json = "{}"
# create an instance of UserpassWriteUserRequest from a JSON string
userpass_write_user_request_instance = UserpassWriteUserRequest.from_json(json)
# print the JSON string representation of the object
print(UserpassWriteUserRequest.to_json())

# convert the object into a dict
userpass_write_user_request_dict = userpass_write_user_request_instance.to_dict()
# create an instance of UserpassWriteUserRequest from a dict
userpass_write_user_request_from_dict = UserpassWriteUserRequest.from_dict(userpass_write_user_request_dict)
```
