...
pki_issuer_issue_with_role_request_instance = PkiIssuerIssueWithRoleRequest.from_json(json)
# print the JSON string representation of the object
print(PkiIssuerIssueWithRoleRequest.to_json())

# convert the object into a dict
pki_issuer_issue_with_role_request_dict = pki_issuer_issue_with_role_request_instance.to_dict()
# create an instance of PkiIssuerIssueWithRoleRequest from a dict
pki_issuer_issue_with_role_request_from_dict = PkiIssuerIssueWithRoleRequest.from_dict(pki_issuer_issue_with_role_request_dict)
```
