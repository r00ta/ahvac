...
json = "{}"
# create an instance of PkiIssueWithRoleRequest from a JSON string
pki_issue_with_role_request_instance = PkiIssueWithRoleRequest.from_json(json)
# print the JSON string representation of the object
print(PkiIssueWithRoleRequest.to_json())

# convert the object into a dict
pki_issue_with_role_request_dict = pki_issue_with_role_request_instance.to_dict()
# create an instance of PkiIssueWithRoleRequest from a dict
pki_issue_with_role_request_from_dict = PkiIssueWithRoleRequest.from_dict(pki_issue_with_role_request_dict)
```
