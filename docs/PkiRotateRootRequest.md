...
pki_rotate_root_request_instance = PkiRotateRootRequest.from_json(json)
# print the JSON string representation of the object
print(PkiRotateRootRequest.to_json())

# convert the object into a dict
pki_rotate_root_request_dict = pki_rotate_root_request_instance.to_dict()
# create an instance of PkiRotateRootRequest from a dict
pki_rotate_root_request_from_dict = PkiRotateRootRequest.from_dict(pki_rotate_root_request_dict)
```
