...
json = "{}"
# create an instance of PkiIssuersGenerateRootRequest from a JSON string
pki_issuers_generate_root_request_instance = PkiIssuersGenerateRootRequest.from_json(json)
# print the JSON string representation of the object
print(PkiIssuersGenerateRootRequest.to_json())

# convert the object into a dict
pki_issuers_generate_root_request_dict = pki_issuers_generate_root_request_instance.to_dict()
# create an instance of PkiIssuersGenerateRootRequest from a dict
pki_issuers_generate_root_request_from_dict = PkiIssuersGenerateRootRequest.from_dict(pki_issuers_generate_root_request_dict)
```
