...
------------ | ------------- | ------------- | -------------
**arn** | **str** | ARN of the RAM to bind to this role. | [optional] 
...
ali_cloud_write_auth_role_request_instance = AliCloudWriteAuthRoleRequest.from_json(json)
# print the JSON string representation of the object
print(AliCloudWriteAuthRoleRequest.to_json())

# convert the object into a dict
ali_cloud_write_auth_role_request_dict = ali_cloud_write_auth_role_request_instance.to_dict()
# create an instance of AliCloudWriteAuthRoleRequest from a dict
ali_cloud_write_auth_role_request_from_dict = AliCloudWriteAuthRoleRequest.from_dict(ali_cloud_write_auth_role_request_dict)
```
