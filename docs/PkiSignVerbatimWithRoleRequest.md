...
json = "{}"
# create an instance of PkiSignVerbatimWithRoleRequest from a JSON string
pki_sign_verbatim_with_role_request_instance = PkiSignVerbatimWithRoleRequest.from_json(json)
# print the JSON string representation of the object
print(PkiSignVerbatimWithRoleRequest.to_json())

# convert the object into a dict
pki_sign_verbatim_with_role_request_dict = pki_sign_verbatim_with_role_request_instance.to_dict()
# create an instance of PkiSignVerbatimWithRoleRequest from a dict
pki_sign_verbatim_with_role_request_from_dict = PkiSignVerbatimWithRoleRequest.from_dict(pki_sign_verbatim_with_role_request_dict)
```
