...
class LdapLibraryCheckOutRequest(BaseModel):
    """
    LdapLibraryCheckOutRequest
    """ # noqa: E501
    ttl: Optional[StrictStr] = Field(default=None, description="The length of time before the check-out will expire, in seconds.")
