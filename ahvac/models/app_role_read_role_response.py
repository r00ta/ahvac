...
class AppRoleReadRoleResponse(BaseModel):
    """
    AppRoleReadRoleResponse
    """ # noqa: E501
    bind_secret_id: Optional[StrictBool] = Field(default=None, description="Impose secret ID to be presented when logging in using this role.")
    local_secret_ids: Optional[StrictBool] = Field(default=None, description="If true, the secret identifiers generated using this role will be cluster local. This can only be set during role creation and once set, it can't be reset later")
    ...
    token_period: Optional[StrictStr] = Field(default=None, description="If set, tokens created via this role will have no max lifetime; instead, their renewal period will be fixed to this value.")
    ...
    __properties: ClassVar[List[str]] = ["bind_secret_id", "local_secret_ids", "period", "policies", "secret_id_bound_cidrs", "secret_id_num_uses", "secret_id_ttl", "token_bound_cidrs", "token_explicit_max_ttl", "token_max_ttl", "token_no_default_policy", "token_num_uses", "token_period", "token_policies", "token_ttl", "token_type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bind_secret_id": obj.get("bind_secret_id"),
