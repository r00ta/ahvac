...
class AliCloudConfigureRequest(BaseModel):
    """
    AliCloudConfigureRequest
    """ # noqa: E501
    access_key: Optional[StrictStr] = Field(default=None, description="Access key with appropriate permissions.")
    secret_key: Optional[StrictStr] = Field(default=None, description="Secret key with appropriate permissions.")
