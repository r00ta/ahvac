...
class KubernetesWriteAuthRoleRequest(BaseModel):
    """
    KubernetesWriteAuthRoleRequest
    """ # noqa: E501
    alias_name_source: Optional[StrictStr] = Field(default='serviceaccount_uid', description="Source to use when deriving the Alias name. valid choices: \"serviceaccount_uid\" : <token.uid> e.g. 474b11b5-0f20-4f9d-8ca5-65715ab325e0 (most secure choice) \"serviceaccount_name\" : <namespace>/<serviceaccount> e.g. vault/vault-agent default: \"serviceaccount_uid\"")
    audience: Optional[StrictStr] = Field(default=None, description="Optional Audience claim to verify in the jwt.")
    ...
    bound_service_account_names: Optional[List[StrictStr]] = Field(default=None, description="List of service account names able to access this role. If set to \"*\" all names are allowed.")
    bound_service_account_namespaces: Optional[List[StrictStr]] = Field(default=None, description="List of namespaces allowed to access this role. If set to \"*\" all namespaces are allowed.")
    ...
    __properties: ClassVar[List[str]] = ["alias_name_source", "audience", "bound_cidrs", "bound_service_account_names", "bound_service_account_namespaces", "max_ttl", "num_uses", "period", "policies", "token_bound_cidrs", "token_explicit_max_ttl", "token_max_ttl", "token_no_default_policy", "token_num_uses", "token_period", "token_policies", "token_ttl", "token_type", "ttl"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "alias_name_source": obj.get("alias_name_source") if obj.get("alias_name_source") is not None else 'serviceaccount_uid',
            "audience": obj.get("audience"),
            "bound_cidrs": obj.get("bound_cidrs"),
            "bound_service_account_names": obj.get("bound_service_account_names"),
            "bound_service_account_namespaces": obj.get("bound_service_account_namespaces"),
