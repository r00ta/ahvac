...
class GoogleCloudEditLabelsForRoleRequest(BaseModel):
    """
    GoogleCloudEditLabelsForRoleRequest
    """ # noqa: E501
    add: Optional[List[StrictStr]] = Field(default=None, description="BoundLabels to add (in $key:$value)")
    remove: Optional[List[StrictStr]] = Field(default=None, description="Label key values to remove")
