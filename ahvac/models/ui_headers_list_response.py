...
class UiHeadersListResponse(BaseModel):
    """
    UiHeadersListResponse
    """ # noqa: E501
    keys: Optional[List[StrictStr]] = Field(default=None, description="Lists of configured UI headers. Omitted if list is empty")
