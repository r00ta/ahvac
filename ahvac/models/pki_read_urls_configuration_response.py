...
class PkiReadUrlsConfigurationResponse(BaseModel):
    """
    ...
    enable_templating: Optional[StrictBool] = Field(default=None, description="Whether or not to enable templating of the above AIA fields. When templating is enabled the special values '{{issuer_id}}' and '{{cluster_path}}' are available, but the addresses are not checked for URI validity until issuance time. This requires /config/cluster's path to be set on all PR Secondary clusters.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "enable_templating": obj.get("enable_templating"),
