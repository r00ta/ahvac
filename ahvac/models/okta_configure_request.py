...
class OktaConfigureRequest(BaseModel):
    ...
    bypass_okta_mfa: Optional[StrictBool] = Field(default=None, description="When set true, requests by Okta for a MFA check will be bypassed. This also disallows certain status checks on the account, such as whether the password is expired.")
    ...
    organization: Optional[StrictStr] = Field(default=None, description="Use org_name instead.")
    production: Optional[StrictBool] = Field(default=None, description="Use base_url instead.")
    token: Optional[StrictStr] = Field(default=None, description="Use api_token instead.")
    ...
    __properties: ClassVar[List[str]] = ["api_token", "base_url", "bypass_okta_mfa", "max_ttl", "org_name", "organization", "production", "token", "token_bound_cidrs", "token_explicit_max_ttl", "token_max_ttl", "token_no_default_policy", "token_num_uses", "token_period", "token_policies", "token_ttl", "token_type", "ttl"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bypass_okta_mfa": obj.get("bypass_okta_mfa"),
