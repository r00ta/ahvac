...
class AppRoleWriteBindSecretIdRequest(BaseModel):
    """
    AppRoleWriteBindSecretIdRequest
    """ # noqa: E501
    bind_secret_id: Optional[StrictBool] = Field(default=True, description="Impose secret_id to be presented when logging in using this role.")
