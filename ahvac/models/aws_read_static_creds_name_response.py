...
class AwsReadStaticCredsNameResponse(BaseModel):
    """
    AwsReadStaticCredsNameResponse
    """ # noqa: E501
    access_key: Optional[StrictStr] = Field(default=None, description="The access key of the AWS Credential")
    secret_key: Optional[StrictStr] = Field(default=None, description="The secret key of the AWS Credential")
