...
class GenerateRandomWithSourceAndBytesResponse(BaseModel):
    """
    GenerateRandomWithSourceAndBytesResponse
    """ # noqa: E501
    random_bytes: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["random_bytes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "random_bytes": obj.get("random_bytes")
        })
        return _obj
