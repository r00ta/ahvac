...
class RateLimitQuotasReadResponse(BaseModel):
    """
    RateLimitQuotasReadResponse
    """ # noqa: E501
    block_interval: Optional[StrictInt] = None
    inheritable: Optional[StrictBool] = None
    ...
    __properties: ClassVar[List[str]] = ["block_interval", "inheritable", "interval", "name", "path", "rate", "role", "type"]
