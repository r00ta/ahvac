...
class PluginsCatalogListPluginsWithTypeResponse(BaseModel):
    """
    PluginsCatalogListPluginsWithTypeResponse
    """ # noqa: E501
    keys: Optional[List[StrictStr]] = Field(default=None, description="List of plugin names in the catalog")
