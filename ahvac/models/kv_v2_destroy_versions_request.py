...
class KvV2DestroyVersionsRequest(BaseModel):
    """
    KvV2DestroyVersionsRequest
    """ # noqa: E501
    versions: Optional[List[StrictInt]] = Field(default=None, description="The versions to destroy. Their data will be permanently deleted.")
