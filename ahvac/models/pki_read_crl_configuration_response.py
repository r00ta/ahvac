...
class PkiReadCrlConfigurationResponse(BaseModel):
    """
    ...
    auto_rebuild_grace_period: Optional[StrictStr] = Field(default=None, description="The time before the CRL expires to automatically rebuild it, when enabled. Must be shorter than the CRL expiry. Defaults to 12h.")
    ...
    delta_rebuild_interval: Optional[StrictStr] = Field(default=None, description="The time between delta CRL rebuilds if a new revocation has occurred. Must be shorter than the CRL expiry. Defaults to 15m.")
    ...
    expiry: Optional[StrictStr] = Field(default=None, description="The amount of time the generated CRL should be valid; defaults to 72 hours")
    ...
    ocsp_expiry: Optional[StrictStr] = Field(default=None, description="The amount of time an OCSP response will be valid (controls the NextUpdate field); defaults to 12 hours")
