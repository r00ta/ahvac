...
class RadiusWriteUserRequest(BaseModel):
    """
    RadiusWriteUserRequest
    """ # noqa: E501
    policies: Optional[List[StrictStr]] = Field(default=None, description="Comma-separated list of policies associated to the user.")
