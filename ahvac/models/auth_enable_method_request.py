...
class AuthEnableMethodRequest(BaseModel):
    """
    AuthEnableMethodRequest
    """ # noqa: E501
    config: Optional[Dict[str, Any]] = Field(default=None, description="Configuration for this mount, such as plugin_name.")
    ...
    plugin_name: Optional[StrictStr] = Field(default=None, description="Name of the auth plugin to use based from the name in the plugin catalog.")
    ...
    type: Optional[StrictStr] = Field(default=None, description="The type of the backend. Example: \"userpass\"")
