...
class KvV2PatchResponse(BaseModel):
    """
    KvV2PatchResponse
    """ # noqa: E501
    created_time: Optional[datetime] = None
    custom_metadata: Optional[Dict[str, Any]] = None
    deletion_time: Optional[StrictStr] = None
    destroyed: Optional[StrictBool] = None
    version: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["created_time", "custom_metadata", "deletion_time", "destroyed", "version"]
