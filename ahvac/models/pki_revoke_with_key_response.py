...
class PkiRevokeWithKeyResponse(BaseModel):
    """
    PkiRevokeWithKeyResponse
    """ # noqa: E501
    revocation_time: Optional[StrictInt] = Field(default=None, description="Revocation Time")
    revocation_time_rfc3339: Optional[datetime] = Field(default=None, description="Revocation Time")
    state: Optional[StrictStr] = Field(default=None, description="Revocation State")
    __properties: ClassVar[List[str]] = ["revocation_time", "revocation_time_rfc3339", "state"]
