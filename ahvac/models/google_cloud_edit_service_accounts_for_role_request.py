...
class GoogleCloudEditServiceAccountsForRoleRequest(BaseModel):
    """
    GoogleCloudEditServiceAccountsForRoleRequest
    """ # noqa: E501
    add: Optional[List[StrictStr]] = Field(default=None, description="Service-account emails or IDs to add.")
    remove: Optional[List[StrictStr]] = Field(default=None, description="Service-account emails or IDs to remove.")
