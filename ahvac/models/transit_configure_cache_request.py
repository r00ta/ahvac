...
class TransitConfigureCacheRequest(BaseModel):
    """
    TransitConfigureCacheRequest
    """ # noqa: E501
    size: Optional[StrictInt] = Field(default=0, description="Size of cache, use 0 for an unlimited cache size, defaults to 0")
