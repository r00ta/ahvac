...
class AliasUpdateByIdRequest(BaseModel):
    """
    ...
    entity_id: Optional[StrictStr] = Field(default=None, description="Entity ID to which this alias should be tied to. This field is deprecated in favor of 'canonical_id'.")
    ...
    __properties: ClassVar[List[str]] = ["canonical_id", "entity_id", "mount_accessor", "name"]
