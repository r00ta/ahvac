...
class PkiSignVerbatimWithRoleRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["alt_names", "common_name", "csr", "exclude_cn_from_sans", "ext_key_usage", "ext_key_usage_oids", "format", "ip_sans", "issuer_ref", "key_usage", "not_after", "other_sans", "private_key_format", "remove_roots_from_chain", "serial_number", "signature_bits", "ttl", "uri_sans", "use_pss", "user_ids"]
