...
class InternalUiListNamespacesResponse(BaseModel):
    """
    InternalUiListNamespacesResponse
    """ # noqa: E501
    keys: Optional[List[StrictStr]] = Field(default=None, description="field is only returned if there are one or more namespaces")
