...
class PkiConfigureCrlRequest(BaseModel):
    """
    ...
    unified_crl: Optional[StrictBool] = Field(default=False, description="If set to true enables global replication of revocation entries, also enabling unified versions of OCSP and CRLs if their respective features are enabled. disable for CRLs and ocsp_disable for OCSP.")
    unified_crl_on_existing_paths: Optional[StrictBool] = Field(default=False, description="If set to true, existing CRL and OCSP paths will return the unified CRL instead of a response based on cluster-local data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "unified_crl": obj.get("unified_crl") if obj.get("unified_crl") is not None else False,
            "unified_crl_on_existing_paths": obj.get("unified_crl_on_existing_paths") if obj.get("unified_crl_on_existing_paths") is not None else False
        })
        return _obj
