...
class AuthTuneConfigurationParametersRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["allowed_response_headers", "audit_non_hmac_request_keys", "audit_non_hmac_response_keys", "default_lease_ttl", "description", "listing_visibility", "max_lease_ttl", "options", "passthrough_request_headers", "plugin_version", "token_type", "user_lockout_config"]
