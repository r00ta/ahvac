...
class AppRoleWriteSecretIdRequest(BaseModel):
    """
    ...
    metadata: Optional[StrictStr] = Field(default=None, description="Metadata to be tied to the SecretID. This should be a JSON formatted string containing the metadata in key value pairs.")
    ...
    __properties: ClassVar[List[str]] = ["cidr_list", "metadata", "num_uses", "token_bound_cidrs", "ttl"]
