...
class PkiIssuerSignIntermediateResponse(BaseModel):
    """
    ...
    expiration: Optional[StrictInt] = Field(default=None, description="Expiration Time")
    issuing_ca: Optional[StrictStr] = Field(default=None, description="Issuing CA")
