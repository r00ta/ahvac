...
class KvV2WriteRequest(BaseModel):
    ...
    KvV2WriteRequest
    """ # noqa: E501
    data: Optional[Dict[str, Any]] = Field(default=None, description="The contents of the data map will be stored and returned on read.")
    options: Optional[Dict[str, Any]] = Field(default=None, description="Options for writing a KV entry. Set the \"cas\" value to use a Check-And-Set operation. If not set the write will be allowed. If set to 0 a write will only be allowed if the key doesn’t exist. If the index is non-zero the write will only be allowed if the key’s current version matches the version specified in the cas parameter.")
    version: Optional[StrictInt] = Field(default=None, description="If provided during a read, the value at the version number will be returned")
    __properties: ClassVar[List[str]] = ["data", "options", "version"]
