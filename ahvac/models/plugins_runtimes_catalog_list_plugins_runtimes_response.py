...
class PluginsRuntimesCatalogListPluginsRuntimesResponse(BaseModel):
    """
    PluginsRuntimesCatalogListPluginsRuntimesResponse
    """ # noqa: E501
    runtimes: Optional[List[Dict[str, Any]]] = Field(default=None, description="List of all plugin runtimes in the catalog")
