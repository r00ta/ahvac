...
class GithubConfigureRequest(BaseModel):
    ...
    """ # noqa: E501
    base_url: Optional[StrictStr] = Field(default=None, description="The API endpoint to use. Useful if you are running GitHub Enterprise or an API-compatible authentication server.")
    ...
    organization: StrictStr = Field(description="The organization users must be part of")
    organization_id: Optional[StrictInt] = Field(default=None, description="The ID of the organization users must be part of")
    ...
    token_policies: Optional[List[StrictStr]] = Field(default=None, description="Comma-separated list of policies. This will apply to all tokens generated by this auth method, in addition to any policies configured for specific users/groups.")
    ...
    __properties: ClassVar[List[str]] = ["base_url", "max_ttl", "organization", "organization_id", "token_bound_cidrs", "token_explicit_max_ttl", "token_max_ttl", "token_no_default_policy", "token_num_uses", "token_period", "token_policies", "token_ttl", "token_type", "ttl"]
