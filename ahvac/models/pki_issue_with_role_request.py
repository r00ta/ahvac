...
class PkiIssueWithRoleRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["alt_names", "common_name", "exclude_cn_from_sans", "format", "ip_sans", "issuer_ref", "not_after", "other_sans", "private_key_format", "remove_roots_from_chain", "serial_number", "ttl", "uri_sans", "user_ids"]
