...
class PkiWriteRoleRequest(BaseModel):
    """
    PkiWriteRoleRequest
    """ # noqa: E501
    ...
    allow_ip_sans: Optional[StrictBool] = Field(default=True, description="If set, IP Subject Alternative Names are allowed. Any valid IP is accepted and No authorization checking is performed.")
    allow_localhost: Optional[StrictBool] = Field(default=True, description="Whether to allow \"localhost\" and \"localdomain\" as a valid common name in a request, independent of allowed_domains value.")
    ...
    allow_wildcard_certificates: Optional[StrictBool] = Field(default=True, description="If set, allows certificates with wildcards in the common name to be issued, conforming to RFC 6125's Section 6.4.3; e.g., \"*.example.net\" or \"b*z.example.net\". See the documentation for more information.")
    ...
    allowed_domains_template: Optional[StrictBool] = Field(default=False, description="If set, Allowed domains can be specified using identity template policies. Non-templated domains are also permitted.")
    ...
    allowed_uri_sans_template: Optional[StrictBool] = Field(default=False, description="If set, Allowed URI SANs can be specified using identity template policies. Non-templated URI SANs are also permitted.")
    ...
    backend: Optional[StrictStr] = Field(default=None, description="Backend Type")
    ...
    client_flag: Optional[StrictBool] = Field(default=True, description="If set, certificates are flagged for client auth use. Defaults to true. See also RFC 5280 Section 4.2.1.12.")
    ...
    enforce_hostnames: Optional[StrictBool] = Field(default=True, description="If set, only valid host names are allowed for CN and DNS SANs, and the host part of email addresses. Defaults to true.")
    ...
    issuer_ref: Optional[StrictStr] = Field(default='default', description="Reference to the issuer used to sign requests serviced by this role.")
    ...
    key_type: Optional[StrictStr] = Field(default='rsa', description="The type of key to use; defaults to RSA. \"rsa\" \"ec\", \"ed25519\" and \"any\" are the only valid values.")
    ...
    max_ttl: Optional[StrictStr] = Field(default=None, description="The maximum allowed lease duration. If not set, defaults to the system maximum lease TTL.")
    ...
    require_cn: Optional[StrictBool] = Field(default=True, description="If set to false, makes the 'common_name' field optional while generating a certificate.")
    ...
    ttl: Optional[StrictStr] = Field(default=None, description="The lease duration (validity period of the certificate) if no specific lease duration is requested. The lease duration controls the expiration of certificates issued by this backend. Defaults to the system default value or the value of max_ttl, whichever is shorter.")
    use_csr_common_name: Optional[StrictBool] = Field(default=True, description="If set, when used with a signing profile, the common name in the CSR will be used. This does *not* include any requested Subject Alternative Names; use use_csr_sans for that. Defaults to true.")
    use_csr_sans: Optional[StrictBool] = Field(default=True, description="If set, when used with a signing profile, the SANs in the CSR will be used. This does *not* include the Common Name (cn); use use_csr_common_name for that. Defaults to true.")
    ...
    def key_type_validate_enum(cls, value):
        ...
        if value not in set(['rsa', 'ec', 'ed25519', 'any']):
            raise ValueError("must be one of enum values ('rsa', 'ec', 'ed25519', 'any')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "allow_ip_sans": obj.get("allow_ip_sans") if obj.get("allow_ip_sans") is not None else True,
            "allow_localhost": obj.get("allow_localhost") if obj.get("allow_localhost") is not None else True,
            "allow_subdomains": obj.get("allow_subdomains"),
            "allow_wildcard_certificates": obj.get("allow_wildcard_certificates") if obj.get("allow_wildcard_certificates") is not None else True,
            ...
            "allowed_uri_sans_template": obj.get("allowed_uri_sans_template") if obj.get("allowed_uri_sans_template") is not None else False,
            ...
            "client_flag": obj.get("client_flag") if obj.get("client_flag") is not None else True,
            ...
            "enforce_hostnames": obj.get("enforce_hostnames") if obj.get("enforce_hostnames") is not None else True,
            ...
            "require_cn": obj.get("require_cn") if obj.get("require_cn") is not None else True,
            ...
            "ttl": obj.get("ttl"),
            "use_csr_common_name": obj.get("use_csr_common_name") if obj.get("use_csr_common_name") is not None else True,
            "use_csr_sans": obj.get("use_csr_sans") if obj.get("use_csr_sans") is not None else True,
