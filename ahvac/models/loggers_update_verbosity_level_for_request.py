...
class LoggersUpdateVerbosityLevelForRequest(BaseModel):
    """
    LoggersUpdateVerbosityLevelForRequest
    """ # noqa: E501
    level: Optional[StrictStr] = Field(default=None, description="Log verbosity level. Supported values (in order of detail) are \"trace\", \"debug\", \"info\", \"warn\", and \"error\".")
